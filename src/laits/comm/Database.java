...
public final class Database {
  ...
  public boolean insertActivityStudent(Task task, String log) throws CommException {
        // if (true) return true;
        String inputLine = "";
        final String WEB = "http://old.javiergs.com/project/laits/adm/dbstudentactivity.php";
        String timeStamp = "";
        String student = user;
        String idtask = "";
        String activity ="";
...
//            url += "?student=" + student + "&idtask=" + idtask + "&activity=" + activity + "&version=" + Main.VERSIONID;
  ...
  public boolean insertLog(Task task, String activity) throws CommException {
        // if (true) return true;
        final String WEB = "http://old.javiergs.com/project/laits/adm/dblog.php";
        String inputLine = "";
        activity = activity.replace(' ', '_');
        activity = activity.replace(':', '_');
        //Check if the server receives the data
  ...
  public boolean insertTicket(Task task, String type, String activity) throws CommException {
        final String WEB = "http://old.javiergs.com/project/laits/adm/dbticket.php";
        activity = activity.replace(' ', '_');
        activity = activity.replace(':', '_');
        //Check if the server receives the data
        boolean done = false;
  ...
  public LinkedList<Task> selectTasksFromDB() throws CommException {
    final String URL = "http://old.javiergs.com/project/laits/adm/dbtask2.php";
