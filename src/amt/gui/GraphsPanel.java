...
public class GraphsPanel extends javax.swing.JPanel {
  ...
  public GraphsPanel(NodeEditor parent, Vertex v, Graph g, GraphCanvas gc) {
    ...
    this.parent = parent;
    correctVertex = t.getNode(v.getNodeName());    
    if (correctVertex == null) {
      try {
        correctVertex = TaskFactory.getInstance().getActualTask().getNode(currentVertex.getNodeName());
      } catch (CommException ex) {
        java.util.logging.Logger.getLogger(GraphsPanel.class.getName()).log(Level.SEVERE, null, ex);
      }
    }
    
    if (correctVertex != null)
      if (!correctVertex.correctValues.isEmpty())
         correctAnswerPanel = new PlotPanel(correctVertex, t.getStartTime(), 
                                              t.getTitle(), t.getUnitTime());
    if (grafica != null) 
      userAnswerPanel.remove(grafica);
    if ((gc.getModelHasBeenRun() == true) && (v.getType()!=amt.graph.Vertex.NOTYPE) 
            && ((!v.EmptyFormula()) || (v.getType() == amt.graph.Vertex.CONSTANT)))
      userAnswerPanel = new PlotPanel(this.currentVertex, t.getStartTime(), 
                                              t.getTitle(), t.getUnitTime());
  ...
  public void resetLayout() {
    ...
    layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(buttonPanel, 
                                                ...
                                                userGraphLabel).addContainerGap(522, Short.MAX_VALUE)
                                      ).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(
                                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING
                                      ).addComponent(userAnswerPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 
                                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE
                                      ).addGroup(layout.createSequentialGroup().addGroup(
                                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING
                                      ).addComponent(correctAnswerPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 
                                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE
                                      ).addGroup(layout.createSequentialGroup().addComponent(
                                                correctGraphLabel).addPreferredGap(
                                                javax.swing.LayoutStyle.ComponentPlacement.RELATED
                                      ).addComponent(nodeDescriptionLabel, javax.swing.GroupLayout.PREFERRED_SIZE
                                                , javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                      ).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 41, Short.MAX_VALUE
                                      ).addComponent(descriptionLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 
                                                250, javax.swing.GroupLayout.PREFERRED_SIZE))).addContainerGap()));
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        add(allGraphsPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 620, -1));

        descriptionLabel.setText("<html><b>Description:</b></html>");
        descriptionLabel.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        add(descriptionLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 450, 58));
        ...
        add(closeButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 10, -1, -1));
