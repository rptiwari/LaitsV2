...
class PopupEdgeMenu extends PopupMenu implements ActionListener {
   ...
   */
  public PopupEdgeMenu(Selectable selectable, GraphCanvas gc, Graph g, JMenuItem run) {
    super();
  ...
  /**
    ...
    public void actionPerformed(ActionEvent e)
    {
        if (e.getActionCommand().equals("delete") && selectable instanceof Edge)
        {
            ...
            logs.concatOut(Logger.ACTIVITY, "PopupEdgeMenu.actionPerformed.1", edge.start.getNodeName() + "-" + edge.end.getNodeName());
        ...
        {
            Edge edge = (Edge) selectable;
            logs.concatOut(Logger.ACTIVITY, "PopupEdgeMenu.actionPerformed.2", "");
