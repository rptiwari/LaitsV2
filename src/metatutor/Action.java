...
public class Action {
  ...
  public static final int RunModel=119;
  public static final int SentModel=120;
  public static final int TabEditing=121;
  ...
  public TimeStamp getTS() {
    ...
    public Action(String line,int status, int actStrPos){
      ...
      String type_str=action_str.split("_")[0].trim();
        ...
        else if(type_str.equals("student chose to close the popup node editor")){
            type=Action.CloseANode;
            param="popup";
        }
        ...
        else if (type_str.equals("student selected the wrong principle")){
          type=Action.ClickCheck;
          param="wrong";
        }
            ...
            param=type_str.split("task:")[1].trim();
        }
        ...
        else if(type_str.startsWith("student chose to give up") || type_str.equals("student chose to give up on the calculations panel")){
          type=Action.ClickGiveup;
        }
        ...
        else if(type_str.startsWith("student chose not to view the instructions tab:the user clicks on the modeling tab")){
          type=Action.ToModelTab;
        }
        else if(type_str.startsWith("student ran the model successfully"))
          type=Action.RunModel;
        else if(type_str.startsWith("all the node's information has been sent."))
          type=Action.SentModel;
        else
          type=Action.UnknownType;
