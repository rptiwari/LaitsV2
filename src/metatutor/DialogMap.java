...
public static void init(){
    ...
    dialogMap.put("Dialog.3", "It's time to choose a node that lacks a blue border as the next target node to work on. "
            + "It doesn't matter which one you choose, because eventually you'll have to work on all of them. Would you prefer to work on ");
